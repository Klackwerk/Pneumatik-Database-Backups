...
* The web interface was reimplemented on Bootstrap
* Backup states are color-coded: finished green, failed red

## Pneumatik 3.2.1

### Fixed

* The generated admin password was never printed at first start. The log
  threshold dropped it, leaving a fresh install with an account nobody could
  sign in to
* Retention, catch-up, notification and startup events are logged again
