...
TypeScript, Bootstrap 5 with react-bootstrap components, TanStack Query for
data fetching, and a typed API client generated from the backend's OpenAPI
contract.
...
| `src/styles/app.scss` | Bootstrap with the brand theme and chart palette |
| `src/components/shared/` | app patterns: page header, form field, confirm dialog, empty state, toasts |
| `src/components/layout/` | authenticated shell (sidebar, mobile offcanvas, guard) |
